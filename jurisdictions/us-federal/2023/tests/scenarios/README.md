# D7 Scenario Coverage - us-federal/2023

Canonical scenario format is JSON. The older `scenario-template.yaml` in this directory is superseded and retained only for audit continuity.
